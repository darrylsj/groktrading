Before making opening-window picks, inspect the full evidence index and prior memory.
Request archived evidence IDs that would resolve material uncertainty across world events,
company news, macro, economic calendar, options pricing/history, and the current portfolio.
You can request up to 40 records per round. Two rounds maximum are supplied by the orchestrator.
