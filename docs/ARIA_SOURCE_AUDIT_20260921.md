...
**Grok decides whether to merge.** HEAD audited: `4f7dca0`.

## Verdict: 🟡 WARN — CI failure
...
- CI (main, latest): **failure**
- Money-path test files (gate/order/live/policy/broker/quote): **8**

Fingerprint: `4f7dca0|WARN — CI failure|sec=0|wall=7|ci=failure|tests=8`
